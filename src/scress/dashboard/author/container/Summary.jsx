...
const Summary = ({ currentValue, value, onSummaryFinishFull, onSummaryFinishOriginal }) => {
    ...
    const handleSubmit = () => {
        if (old == "3r") {
            onSummaryFinishOriginal(value + 1, currentValue);
        } else {
            onSummaryFinishFull(value + 2, currentValue);
        }
    };
